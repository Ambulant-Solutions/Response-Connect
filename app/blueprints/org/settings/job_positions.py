...
@settings_bp.get("/job-positions")
@permission_required("hr:configure")
def job_position_index():
    return render_template(
        "org/settings/job_positions/index.html",
...
def job_position_create():
    ...
    return render_template(
        "org/settings/job_positions/form.html",
        form=form,
        position=None,
        active_org_section="settings",
    )
...
@settings_bp.route(
    "/job-positions/<uuid:position_id>/edit",
    methods=["GET", "POST"],
)
@permission_required("hr:configure")
...
@settings_bp.post(
    "/job-positions/<uuid:position_id>/deactivate"
)
@permission_required("hr:configure")
...
@settings_bp.post(
    "/job-positions/<uuid:position_id>/activate"
)
@permission_required("hr:configure")
